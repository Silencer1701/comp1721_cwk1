...
public class Basic {
  ...
  @Test
  @DisplayName("DatasetException thrown for invalid case counts")
  ...
  @Test
  @DisplayName("DatasetException if using invalid index to retrieve a record")
  ...
  @Test
  @DisplayName("DatasetException if no record found for required date")
